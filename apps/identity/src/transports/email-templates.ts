	...
	return layout({
		...
		children: createElement(
			...
			createElement(
				Text,
				{ style: leadStyle, className: 'ww-body-text' },
				'Вы получили это письмо, потому что для данного адреса был запрошен временный пароль. Он действует 10 минут. Прежний пароль заменится только после входа с временным паролем. Если вы не запрашивали восстановление, проигнорируйте письмо.'
			),
			createElement(
				Section,
				{
