...
DO $$
BEGIN
    IF to_regnamespace('crm_sales') IS NULL THEN
        EXECUTE 'CREATE SCHEMA "crm_sales"';
    END IF;
END
$$;
...
CREATE TABLE "crm_sales"."service_identity" (
    ...
    CONSTRAINT "service_identity_name_check" CHECK ("service_name" = 'crm-sales-service')
);

CREATE UNIQUE INDEX "service_identity_database_id_key"
ON "crm_sales"."service_identity"("database_id");

INSERT INTO "crm_sales"."service_identity" (
    "id",
    "service_name",
    "database_id",
    "created_at",
