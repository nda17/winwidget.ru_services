import { CampaignsDependenciesClient } from './campaigns-dependencies.client';
...
function createClient(
	...
	return new CampaignsDependenciesClient(
		createConfig({
...
describe('CampaignsDependenciesClient hardening', () => {
	afterEach(() => {
		jest.restoreAllMocks();
	});

	it.each([
		'http://remote-service:4200',
		'http://10.0.0.2:4200',
