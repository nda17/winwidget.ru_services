...
export const AI_CONSENT_DOCUMENT_VERSION = 'ai-consultant-consent-v1';
export const AI_CONSENT_STATEMENT_TEXT =
	'Я соглашаюсь на обработку моего вопроса и до 12 последних сообщений контекста для формирования и проверки ответа AI-консультанта, передачу этих данных Cloudflare Workers AI и техническую проверку Cloudflare Turnstile. Я ознакомлен(а) с политикой обработки данных владельца сайта и обязуюсь не указывать специальные категории, биометрические и иные избыточные персональные данные.';
