...
if [[ "$DEPLOY_TARGET" == 'platform' ]]; then
  ...
  -n "$PLATFORM_ENV_EXPECTED_SHA256$PLATFORM_FRONTEND_REVISION$PLATFORM_FRONTEND_RUNTIME_CHALLENGE$PLATFORM_FRONTEND_ORIGIN$PLATFORM_FRONTEND_EXPECTED_ATTESTATION_SHA256$PLATFORM_FRONTEND_EXPECTED_SIGNATURE_SHA256$PLATFORM_FRONTEND_TRUSTED_PUBLIC_KEY_SHA256" ]]; then
