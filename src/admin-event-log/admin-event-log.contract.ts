export const CORE_ADMIN_EVENT_LOG_SECTIONS = [
	'PAYMENTS',
	'CAMPAIGNS',
	'TASKS',
	'SUBSCRIPTIONS',
...
export type AdminEventLogSection =
	(typeof CORE_ADMIN_EVENT_LOG_SECTIONS)[number];

export const CORE_ADMIN_EVENT_LOG_ACTIONS = [
...
export type AdminEventLogAction =
	(typeof CORE_ADMIN_EVENT_LOG_ACTIONS)[number];
