...
export const PAYMENT_CHECKOUT_TTL_MS = 60 * 60 * 1000;
export const PAYMENT_RECONCILIATION_INTERVAL_MS = 60 * 1000;
export const AUTO_RENEWAL_SCHEDULER_INTERVAL_MS = 60 * 1000;
...
export const isAutoRenewalRetryableCancellation = (reason: string) =>
	AUTO_RENEWAL_RETRYABLE_CANCELLATION_REASONS.has(reason);
