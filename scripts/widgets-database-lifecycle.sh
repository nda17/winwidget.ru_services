...
WIDGETS_CANONICAL_STEADY_INTEGRATION_WORKER_KINDS='campaign-admin-audit,reporting-admin-audit,widgets-admin-audit,billing-admin-audit,identity-admin-audit,platform-admin-audit,billing-payment-projection,billing-subscription-projection,billing-affiliate-projection'
...
widgets_lifecycle_self_test() {
	...
	[[ "$WIDGETS_CANONICAL_STEADY_INTEGRATION_WORKER_KINDS" == *'widgets-admin-audit'* &&
		...
		"$WIDGETS_CANONICAL_STEADY_INTEGRATION_WORKER_KINDS" == *'identity-admin-audit'* &&
		"$WIDGETS_CANONICAL_STEADY_INTEGRATION_WORKER_KINDS" == *'platform-admin-audit'* &&
		...
		"$WIDGETS_CANONICAL_STEADY_INTEGRATION_WORKER_KINDS" != *'telegram-destination-unavailable'* &&
