...
const required = [
  ...
  "'winwidget.platform_queue_evidence_sha256'",
	...
	"current_setting('winwidget.operations_platform_source_cleanup', true) = 'production-destructive-approved'",
	"current_setting('winwidget.operations_platform_source_writers_stopped', true) = 'true'",
	"current_user = 'gen_user'",
	"session_user = 'gen_user'",
	"current_setting('winwidget.operations_platform_core_database_name', true)",
	"current_setting('winwidget.operations_platform_core_database_system_identifier', true)",
	"current_setting('winwidget.operations_platform_ownership_revision', true)",
	"current_setting('winwidget.operations_platform_cleanup_revision', true)",
	"current_setting('winwidget.operations_platform_migration_sha256', true)",
	"current_setting('winwidget.operations_platform_production_env_sha256', true)",
	"current_setting('winwidget.operations_platform_compose_sha256', true)",
	"activity.usename IN ('gen_user', 'winwidget_api_runtime')",
	"COALESCE(operations_terminal_approved, false)",
