...
identity_deploy_verify_environment() {
	...
	api)
		...
		for required in IDENTITY_CORE_TOKEN CORE_IDENTITY_TOKEN \
			...
			OPERATIONS_INTERNAL_BASE_URL OPERATIONS_IDENTITY_TOKEN \
			...
			IDENTITY_AVATAR_S3_BUCKET IDENTITY_AVATAR_S3_ACCESS_KEY_ID \
	...
	worker | outbox-publisher)
		...
		for forbidden in IDENTITY_AVATAR_S3_ENDPOINT \
			IDENTITY_AVATAR_S3_REGION IDENTITY_AVATAR_S3_BUCKET \
