...
REPORTING_CURRENT_IDENTITY_STEADY_INTEGRATION_WORKER_KINDS='campaign-admin-audit,reporting-admin-audit,widgets-admin-audit,billing-admin-audit,identity-admin-audit,platform-admin-audit,support-admin-audit,billing-payment-projection,billing-subscription-projection,billing-affiliate-projection'
...
reporting_database_lifecycle_self_test() {
	...
	[[ "$REPORTING_CURRENT_IDENTITY_STEADY_INTEGRATION_WORKER_KINDS" == *'billing-admin-audit'* &&
		...
		"$REPORTING_CURRENT_IDENTITY_STEADY_INTEGRATION_WORKER_KINDS" == *'platform-admin-audit'* &&
