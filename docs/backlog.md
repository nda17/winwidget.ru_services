...
### P0 — завершить production browser-проверку возвращённого лендинга
...
- сохранность текущего контента Widgets, query/UTM и старых точных
  `/#tools`, `/#pricing`, `/#faq` ссылок на самой главной после hydration,
  без перенаправления на удалённые страницы;
