...
- реализовать автосписания WinCRM по согласованной модели Widgets: первоначальная
...
- при изменении оплаченного количества мест сразу пересчитывать оставшееся
