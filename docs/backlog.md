...
Каноническая версия backlog хранится вместе с backend-сервисами в этом
репозитории.
...
Кодовые и health-check проверки не доказывают реальное движение денег,
доставку webhook и регистрацию чека. До появления клиентов требуется внешняя
проверка production-контура:

- подтвердить в ЮKassa доступность первоначальных и рекуррентных платежей для
  production merchant, актуальность webhook и подключение онлайн-кассы;
